...
# MediaPipe's top-level import pulls in an optional TensorFlow docs helper.
# Provide a tiny shim so the demo does not fail when TensorFlow is unavailable.
def _install_tensorflow_docs_stub() -> None:
